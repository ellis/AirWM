...
export default class Container {
	...
	redraw() {
		...
		if( this.tiling_mode === "horizontal" ) {
			console.log(3)
			var child_width = parseInt( (this.dimensions.width-(this.children.length-1)*screen.margin) / this.children.length);
			console.log(31)
			for( var i=0; i<this.children.length; ++i ) {
				console.log(32)
				this.children[i].dimensions.x      = this.dimensions.x + (child_width+screen.margin)*i;
			...
			console.log(4)
			var child_height = parseInt( (this.dimensions.height-(this.children.length-1)*screen.margin) / this.children.length);
			for( var i=0; i<this.children.length; ++i ) {
				this.children[i].dimensions.x      = this.dimensions.x;
				this.children[i].dimensions.y      = this.dimensions.y + (child_height+screen.margin)*i;
