...
function Workspace() {
	...
	this.addDockWindow = function(wid, properties) {
		let [left, right, top, bottom, left_start_y, left_end_y, right_start_y, right_end_y, top_start_x, top_end_x, bottom_start_x, bottom_end_x] = properties["_NET_WM_STRUT_PARTIAL"];
	}
